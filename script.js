...
const resources = {
    ...
    2: { label: 'ChromeDino++', link: 'https://fdcodestudio.github.io/collection-showcase/ai-app/gesture-chrome-dino' },
    3: { label: 'CP Basic Learning Modules', link: 'https://drive.google.com/drive/folders/1uG-ftIpRtB9MnWMLCeWZTwfv0qKNQD1m' },
    4: { label: 'CP Intermediate PDF', link: 'https://drive.google.com/file/d/1Y3WEfcccNms8zY7L74hHKZ6lHM-uJwAh/view' },
    5: { label: 'CP Advanced Resources', link: 'https://drive.google.com/drive/folders/1LGb6n43T-GK_W-QuIBUpQzVFw-MWFO1X' },
    6: { label: 'CFN Learning Modules', link: 'https://drive.google.com/drive/folders/1EZRsbwpZ2bI9U8csVzW-KtRS3c78BFIs' },
    7: { label: 'CFN Challenge Exercises', link: 'https://example.com' },
    ...
    10: { label: 'PAN Learning Modules', link: 'https://drive.google.com/drive/folders/1jg5Yhj96prV985nJbnh2WolAl7CABBjh' },
    11: { label: 'PAN Challenge Exercises', link: 'https://drive.google.com/file/d/1SRiyKZP4Ob_nHQKX9REc62xFSJnFRvOP/view' },
    12: { label: 'PF Learning Modules', link: 'https://drive.google.com/drive/folders/1pi1SiNcdXTkja7K_wld9nqyDTVsL7R5x' },
    13: { label: 'PF Challenge Exercises', link: 'https://drive.google.com/file/d/1aCKy2OE_hXe4IkiMKopH23Kc1JVq0D6u/view' },
};
...
const messages = [
    ...
    { text: "> [03] CP Basic Learning Modules \n" },
    { text: "> [04] CP Intermediate PDF \n" },
    { text: "> [05] CP Advanced Resources \n\n" },
    { text: ">> P VII | Computer Fundamental National (CFN) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [06] CFN Learning Modules \n" },
    { text: "> [07] CFN Challenge Exercises \n\n" },
    { text: ">> P VIII | Programming Fundamental National (PFN) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [08] PFN Learning Modules \n" },
    { text: "> [09] PFN Challenge Exercises \n\n" },
    { text: ">> P IX | Programming Advanced National (PAN) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [10] PAN Learning Modules \n" },
    { text: "> [11] PAN Challenge Exercises \n\n" },
    { text: ">> VIII | Programming Fundamental (PF) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [12] PF Learning Modules \n" },
    { text: "> [13] PF Challenge Exercises \n\n" },
