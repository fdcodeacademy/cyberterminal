...
const resources = {
    ...
    6: { label: 'CFN Homework Submission', link: 'https://example.com' },
    7: { label: 'CFN Project Submission', link: 'https://forms.gle/ZZ3Ta4UPYFLoRaw66' },
    ...
    19: { label: 'PF Project Submission', link: 'https://forms.gle/RC8zFMF3JfB5z8JP7' },
    20: { label: 'ChromeDino++', link: 'https://fdcodestudio.github.io/collection-showcase/ai-app/gesture-chrome-dino' }
};
...
const messages = [
    ...
    { text: "> [06] CFN Homework Submission \n" },
    { text: "> [07] CFN Project Submission \n\n" },
    { text: ">> P VIII | Programming Fundamental National (PFN) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [08] PFN Learning Modules \n" },
    { text: "> [09] PFN Challenge Exercises \n" },
    { text: "> [10] PFN Homework Submission \n" },
    { text: "> [11] PFN Project Submission \n\n" },
    { text: ">> P IX | Programming Advanced National (PAN) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [12] PAN Learning Modules \n" },
    { text: "> [13] PAN Challenge Exercises \n" },
    { text: "> [14] PAN Homework Submission \n" },
    { text: "> [15] PAN Project Submission \n\n" },
    { text: ">> VIII | Programming Fundamental (PF) << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [16] PF Learning Modules \n" },
    { text: "> [17] PF Challenge Exercises \n" },
    { text: "> [18] PF Homework Submission \n" },
    { text: "> [19] PF Project Submission \n\n" },
    { text: ">> Bonus << \n", style: "color: #b19cd9; text-decoration: underline" },
    { text: "> [20] ChromeDino++ \n\n" },
